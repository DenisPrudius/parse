...
Скрипт написаний на Python проходить каталог товарів, збирає інформацію з плиток та автоматично зберігає дані у CSV-файл.
...
The script iterates through all catalog pages, extracts product information, and saves the results into a CSV file.
